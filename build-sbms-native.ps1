...
$Command = "`"$VsDevCmd`" -arch=x64 -host_arch=x64 >nul && cl /nologo /std:c++17 /EHsc /O2 /MD /W4 /DUNICODE /D_UNICODE `"$Source`" /Fe:`"$Out`" d3d11.lib dxgi.lib d3dcompiler.lib user32.lib gdi32.lib"
cmd.exe /d /c $Command
