...
Invoke-TestCase 'Release manifest contains reproducible source and package data' {
    ...
    Assert-True (@($data.components.PSObject.Properties.Name) -notcontains 'maintenanceService') 'Unreleased maintenance service must not be declared as a release component.'
